...
- [`Using_pyCloudy_3_spherical_profiles_rhd_wind.py`](../python_examples/Using_pyCloudy_3_spherical_profiles_rhd_wind/Using_pyCloudy_3_spherical_profiles_rhd_wind.py): RHD stellar-wind profile variant using `radial_profile_rhd_wind.csv`, with `10^-6 Msun/yr` and `1000 km/s` represented by the external profile; see [`Using_pyCloudy_3_spherical_profiles_rhd_wind.md`](Using_pyCloudy_3_spherical_profiles_rhd_wind.md).
- [`Using_pyCloudy_3_spherical_profiles_rhd_wind_temperature.py`](../python_examples/Using_pyCloudy_3_spherical_profiles_rhd_wind_temperature/Using_pyCloudy_3_spherical_profiles_rhd_wind_temperature.py): Batch RHD stellar-wind workflow reading `RADIUS_PC`, `VELOCITY_KMS`, `DENSITY_CM3`, and `TEMP_K` from CSV files in `radial_profiles/`, using `q(H)=10^49 s^-1` and isolated per-profile output directories; see [`Using_pyCloudy_3_spherical_profiles_rhd_wind_temperature.md`](Using_pyCloudy_3_spherical_profiles_rhd_wind_temperature.md).
